...
class fenetre(QWidget) :
    ...
    def changementAffichage(self):
        """Cette fonction permet d'affichier la moyenne ou la median 
        si l'user à sélectionner 1 des 2 solutions
        """
    ...
    def openFileDialog(self):
        ...
        for i in range(len(listeFichiersData)):
            ...
            for j in range(len(listeFichiersData[i])):
                ...
                # si threshold est inférieur au z-score alors supprime le pixel incohérents
                if (z > threshold).any():
